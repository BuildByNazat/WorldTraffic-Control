# WorldTraffic Control - Start Backend (Manual)
# Run from current shell:  .\scripts\run-backend-manual.ps1
# This is identical to run-backend.ps1 but named for manual use clarity.
...
Write-Output ""
Write-Output "--- WorldTraffic Control Backend (Manual Mode) ---"
